...
Verification and sanity-check script for Thesis Report Generator Module (Part 9.6).
"""
...
print(LINE)
print(" THESIS REPORT & PUBLICATION SYNTHESIZER CHECK (PART 9.6)")
print(LINE)

generator = ThesisReportGenerator(output_directory="backtesting/results/thesis_report")
artifacts = generator.generate_all_reports()

print("-" * 75)
print("GENERATED PUBLICATION ARTIFACTS")
print("-" * 75)
print(f"Thesis Markdown Report : {artifacts.report_markdown.exists()} ({artifacts.report_markdown})")
...
print("\n" + "-" * 75)
print("PREVIEW: THESIS CHAPTER 5 STRUCTURE (FIRST 25 LINES)")
print("-" * 75)
...
print("\n" + LINE)
print("Thesis report generator verified successfully ✓")
print(LINE)