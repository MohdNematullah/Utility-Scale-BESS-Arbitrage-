...
print(LINE)
print(" RESEARCH SCENARIOS LIBRARY VERIFICATION")
print(LINE)
...
for cat in ScenarioCategory:
    ...
    print(f"Category '{cat.value}': {len(cat_scenarios)} scenarios ✓")
...
print("SCN_CHEM_LFP Modifier Verification: PASSED ✓")

t45_cfg, t45_bat = get_scenario("SCN_TEMP_45C").instantiate_configs()
assert t45_bat.ageing.reference_temperature_c == 45.0, "Thermal 45°C not updated."
print("SCN_TEMP_45C Modifier Verification: PASSED ✓")
...
print("SCN_SIZE_100MW_200MWH Modifier Verification: PASSED ✓")
...
print("SCN_EFF_95PCT Modifier Verification: PASSED ✓")

print(LINE)
print("Scenario library verified successfully with all 28 scenarios intact ✓")
print(LINE)